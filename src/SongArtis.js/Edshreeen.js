...
import song1 from '../Songs/Edshreen/Edshreen/IDontCare.mp3'
import song2 from '../Songs/Edshreen/Edshreen/malik.mp3'
import song3 from '../Songs/Edshreen/Edshreen/perfect.mp3'
import song4 from '../Songs/Edshreen/Edshreen/ShapeOfYou .mp3'
import Edshreen from '../images/EdShreen.png'

// Sample song data
const sampleSongs = [
  { id: 1, title: "IDontCare", artist: "Edshreen", duration: "6:12", url: song1 },
  { id: 2, title: "malik", artist: "Edshreen", duration: "4:22", url: song2 },
  { id: 3, title: "perfect", artist: "Edshreen", duration: "5:30", url: song3 },
  { id: 4, title: "ShapeOfYou", artist: "Edshreen", duration: "5:08", url: song4 },
  
]

export default function Edshreeen() {
          ...
          {currentSong ? (
            <>
              <div className="album-art">
                <img src={Edshreen} alt={currentSong.title} />
              </div>
