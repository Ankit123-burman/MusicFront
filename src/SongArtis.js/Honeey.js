...
import song1 from '../Songs/Honey Singh/Honey Singh/International .mp3'
import song2 from '../Songs/Honey Singh/Honey Singh/Love.mp3'
import song3 from '../Songs/Honey Singh/Honey Singh/Millionaire.mp3'
import song4 from '../Songs/Honey Singh/Honey Singh/Nachche .mp3'
import song5 from '../Songs/Honey Singh/Honey Singh/Payal.mp3'
import Honey from '../images/Honey.png'

// Sample song data
const sampleSongs = [
  { id: 1, title: "International", artist: "Honey Singh", duration: "6:12", url: song1 },
  { id: 2, title: "Love", artist: "Honey Singh", duration: "4:22", url: song2 },
  { id: 3, title: "Millionaire", artist: "Honey Singh", duration: "5:30", url: song3 },
  { id: 4, title: "Nachche", artist: "Honey Singh", duration: "5:08", url: song4 },
  { id: 5, title: "Payal", artist: "Honey Singh", duration: "5:08", url: song5 },
  
]

export default function Honeey() {
          ...
          {currentSong ? (
            <>
              <div className="album-art">
                <img src={Honey} alt={currentSong.title} />
              </div>
